...
html"""
<p style="font-size:20px;">Ariel Struzyk, Lourdes Latasa, Monona Khlare</br>
...
# ╔═╡ 6f311a7e-dafc-4721-95d6-2c815f4a1d63
pidx = 14
#extreme pathway 4 produces urea
...
# ╔═╡ 8dfc3929-d1db-404f-b190-123c89631e59
#There isn't really a correlation between reaction frequency and reaction connectivity with this model.
...
begin
	...
	# internal reactions -
	push!(reaction_array, "v₁,ATP+citrulline+aspartate,AMP+diphosphate+2-(Nomega-L-arginino)succinate,false")
	#push!(reaction_array, "v₂,2-(Nomega-L-arginino)succinate,fumarate+arginine,false")
	#push!(reaction_array, "v₃,arginine+H2O,ornithine+urea,false")
	#push!(reaction_array, "v₄,carbamoyl phosphate+ornithine,phosphate+citrulline,false")
	#push!(reaction_array, "v₅,2*arginine+3*NADPH+3*Hplus+4*O2,citrulline+2*nitricoxide+3*NADPplus+4*H2O,true")
	...
	#push!(reaction_array, "b₈,∅,NADPH,true")
	#push!(reaction_array, "b₉,∅,Hplus,true")
	#push!(reaction_array, "b₁₀,∅,O2,true")
	#push!(reaction_array, "b₁₁,nitricoxide,∅,true")
	#push!(reaction_array, "b₁₂,NADPplus,∅,true")
	#push!(reaction_array, "b₁₃,phosphate,∅,false")
	#push!(reaction_array, "b₁₄,∅,H2O,false")
	#push!(reaction_array, "b₁₅,H2O,∅,true")
	...
	push!(reaction_array,"v₅,2*L-arginine+3*NADPH+3*Hplus+4*O2,2*L-citrulline+2*nitricoxide+3*NADPplus+4*H2O,true")
	...
	#what is needed for the reversible reaction v₅ (each would have to be reversible):
	push!(reaction_array,"b₉,∅,NADPH,true")
	push!(reaction_array,"b₁₀,∅,Hplus,true")
	push!(reaction_array,"b₁₁,∅,O2,true")
	push!(reaction_array,"b₁₂,nitricoxide,∅,true")
...
# ╔═╡ 0a12ef08-f945-4935-adea-0c7524feea1a
reaction_name_array[3]

# ╔═╡ 4b7b2b83-8f61-4308-8f5a-c329a700c96a
# 4 reactions
rank_tied_4_reactions=species_array[5],species_array[6],species_array[8],species_array[10],species_array[11],species_array[12],species_array[16]

# ╔═╡ 78d7ac07-ae4a-4117-a828-be84afa33805
#3 reactions
rank_tied_3_reactions=species_array[4]

# ╔═╡ 0ac9976a-10a4-46e3-b5db-024f84956f8f
#2 reactions
rank_tied_2_reactions=species_array[1],species_array[2],species_array[3],species_array[7],species_array[9],species_array[13],species_array[14],species_array[15],species_array[17],species_array[18]

# ╔═╡ b11954e8-29e4-4858-b9bc-11404ce7911e
reaction_name_array[15]

# ╔═╡ e81a6636-1a9b-494a-b118-8800f54f33b1
#8 Metabolites
rank_tied_8_metabolites=reaction_name_array[5:6]

# ╔═╡ 95a2b16d-5c25-4334-b404-dcf1299d0075
#6 Metabolites
rank_tied_6_metabolites=reaction_name_array[1]

# ╔═╡ f59f9b84-f704-4b71-bc69-89595ffe960c
#4 Metabolites
rank_tied_4_metabolites=reaction_name_array[3:4]

# ╔═╡ 6c94e0d9-8b23-4d46-b736-28aaada9a2f1
#3 Metabolites
rank_tied_3_metabolites=reaction_name_array[2]

# ╔═╡ b184af9f-7a6f-47ce-a135-c3215afce08a
#1 Metabolite
rank_tied_one_metabolite=reaction_name_array[6:end]
...
#There are 10 extreme pathways

# ╔═╡ 10014acb-fe67-469e-81ac-0a01d5583d44
P[1:end,3]

# ╔═╡ 7811fbd9-0cd9-4261-bd5e-db4397210ed1
P

# ╔═╡ b8c2c722-ccde-42ed-84df-599e078fea43
begin
...
# ╔═╡ 84f07ac0-9c44-4fbd-86c2-21e267477ea7
begin
	#reaction frequency
	BofP = P |> lib.binary_stoichiometric_matrix
	frequency=sum(BofP, dims=1)/size(BofP)[1]
	Print(frequency)
end

# ╔═╡ 40866480-5823-48e8-bec8-c0665a023c1c
BofP
...
# ╔═╡ 4734c0de-1ed5-4051-8390-cc9ec0dddcff
diagmca=diag(MCA)
...
# ╔═╡ 32a8c780-68f9-492e-aae5-74ae54ff1d0e
Print(frequency)

# ╔═╡ 15008c66-8da4-4fc9-96ec-b4d82acef450
diag(RCA)
